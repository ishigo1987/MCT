...
//        });
    const retrievesAreaToDb = require('../modules/retrieveAreasToDb.js')();
          retrievesAreaToDb.then((response)=>{
             if(response.Message === "Data retrieves with success"){
                  ...
                  if(pickerSellArea.selectionIndex === 0){
                    ...
                    if(pickerTypeOfPlanter.selectionIndex === 2){
                      ...
                      userInfos.zoneName = zonesArray[pickerSellArea.selectionIndex].areaName;
