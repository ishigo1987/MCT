module.exports = ()=>{
 return new Promise((resolve,reject)=>{
   ...
   let db = null;
       ...
       db.transaction((tx)=>{
          tx.executeSql('CREATE TABLE planteurs (id INT, name VARCHAR(255), telephone VARCHAR(255), section VARCHAR(255), commission VARCHAR(255), matricule VARCHAR(255), long_sechoir INT, image TEXT, groupeplanteur TEXT, know BOOLEAN, data_provenance VARCHAR(255))');
